...
export default function Home() {
  ...
  const [selectedOption, setSelectedOption] = useState('qqkj'); // 初始选择第一个选项
        ...
        <div className="flex flex-row">
          ...
          <div className="flex  flex-col sm:flex-col   md:w-auto lg:flex-row xl:flex-row  2xl:flex-row  mx-auto items-center  ">
            ...
            <select
              ...
              <option value="qqkj">腾讯</option>
              <option value="vviptuangou">VIP团购</option>
              <option value="58img">58img</option>
              <option value="csjk">国际学院</option>
              <option value="126">网易</option>
